...
const HELP_CONTENT = {
  ...
  timers: {
    ...
    html: '<h3>Overview</h3>'
      ...
      + '<ul>'
      + '<li>Timers can be started via a <strong>channel point redeem</strong> or the chat command <code>!timer &lt;name&gt;</code>.</li>'
      + '<li>You can also start, pause, or reset any timer manually from its card.</li>'
      + '<li><strong>Save as Preset</strong> keeps a timer setup around so you can add it again later with one click.</li>'
      + '<li><strong>Auto-resume</strong> saves the timer position and picks it back up when SPARK reopens.</li>'
      + '</ul>'
      + '<h3>OBS Overlay</h3>'
